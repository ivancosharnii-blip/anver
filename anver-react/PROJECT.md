...
Каталог-страницы содержат панель: «Категории» (Комплекты, Наборы, Пододеяльники и покрывала, Простыни, Наволочки) и «Ткани» (Sateen Premium, Sateen Luxe, Sateen Stripes, Pure Cotton Ranforce). Ссылки — из оригинала.

⚠️ **Известный вопрос**: ссылки `/sateen-premium`, `/sateen-luxe`, `/sateen-stripes`, `/duvet-covers`, `/pure-cotton-ranforce` ведут на **несуществующие страницы** (404). В оригинале они есть на живом Tilda-сайте, но не в выгрузке. Предложение: `/sateen-premium → /sateen`, `/sateen-stripes → /sateen-stripe`, `/pure-cotton-ranforce → /ranforce`; для `/sateen-luxe` и `/duvet-covers` — создать страницы или убрать ссылки.

---

## 7. Контакты и данные (lib/site.ts)

- Телефон: 078282508 / +37378282508 (tel:)
...
- [ ] Ссылки панели категорий на несуществующие страницы (см. §6) — решить: редирект/создать/убрать
- [ ] Разный футер для главной и каталог-страниц (в оригинале t977 каталога: колонки «Все белье»=Комплекты/Пододеяльники/…, «Наши ткани», телефон +373 794 76 327) — сейчас общий футер главной
- [ ] `metadata.title` страниц пока на русском (SEO-заголовки) — при необходимости двуязычные
- [ ] «Send/Phone/Username or phone number» в форме контактов — в русской версии оставлены как в оригинале (англ. Tilda-шаблон); можно заменить на «Отправить/Телефон»
- [ ] Подключение Supabase (MCP) для заказов/товаров — не используется
- [ ] Сравнение с живым сайтом anver.md (сейчас недоступен из рабочей сети; эталон — выгрузка `../site/`)
